...
function glass_meta_box_output($post)
{
    ...
    <p>
        ...
        <input type="text" name="glass1_textfield" id="glass1_textfield"
               value="<?php echo glass_get_custom_field('glass1_textfield'); ?>" size="50"/>
    </p>
    <p>
        <label for="glass2_textfield"><?php _e('ابعاد ( سانتیمتر ) ', 'textdomain'); ?>:</label>
        <input type="text" name="glass2_textfield" id="glass2_textfield"
               value="<?php echo glass_get_custom_field('glass2_textfield'); ?>" size="50"/>
    </p>
    <p>
        <label for="glass3_textfield"><?php _e('جنس ', 'textdomain'); ?>:</label>
        <input type="text" name="glass3_textfield" id="glass3_textfield"
               value="<?php echo glass_get_custom_field('glass3_textfield'); ?>" size="50"/>
    </p>
    <p>
        <label for="glass4_textfield"><?php _e('وزن ', 'textdomain'); ?>:</label>
        <input type="text" name="glass4_textfield" id="glass4_textfield"
               value="<?php echo glass_get_custom_field('glass4_textfield'); ?>" size="50"/>
    </p>
    <p>
        <label for="glass5_textfield"><?php _e('رنگ ', 'textdomain'); ?>:</label>
        <input type="text" name="glass5_textfield" id="glass5_textfield"
               value="<?php echo glass_get_custom_field('glass5_textfield'); ?>" size="50"/>
    </p>
    <?php
...
<div style="padding-bottom: 8px;">
    ...
    <p style="float: right;margin-bottom: 0;">
        <strong>ابعاد (سانتیمتر)
            : </strong><?php echo get_post_meta(get_the_ID(), 'glass2_textfield', true); ?>
    </p>
</div>
<br>
<div style="padding-bottom: 8px;">
    <i style="float: right;padding-left: 5px;" class="fa fa-tint"></i>
    <p style="float: right;margin-bottom: 0;">
        <strong>جنس
...
<br>
<div style="padding-bottom: 8px;">
    <i style="float: right;padding-left: 5px;" class="fa fa-globe"></i>
    <p style="float: right;margin-bottom: 0;">
        <strong>وزن
...
<div style="padding-bottom: 25px;">
    <i style="float: right;padding-left: 5px;" class="fa fa-eyedropper"></i>
    <p style="float: right;margin-bottom: 0;">
        <strong>رنگ
